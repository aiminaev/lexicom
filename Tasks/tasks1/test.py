def service(technic):
    ...
    for i in technic:
        if name in i:
            repair.append('{} - {};'.format(i[0],i[1]))
    return f'{name} {i[3]}: {" ".join(repair)}'


technik=[('Ноутбук',1500, 'Татьяна', '89002001020'),
         ('Смартфон',500, 'Анна', '89202202325'),
         ('Проектор ',300, 'Андреи', '89505205656'),
         ('Принтер',750, 'Игорь', '89303303236'),
         ('Планшет',2300, 'Игорь', '89303303236'),
         ('Смартфон',1000, 'Андреи', '89505205656'),
